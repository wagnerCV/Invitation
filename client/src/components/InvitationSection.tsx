    ...
    <section id="invitation" className="relative py-24 px-4 md:py-32 bg-off-white overflow-hidden">
      ...
      <div className="container relative z-10 max-w-4xl mx-auto">
        <motion.div
          ...
          className="bg-off-white/80 backdrop-blur-sm border border-sand p-8 md:p-16 text-center shadow-xl shadow-sand/10 relative"
        >
          {/* Decorative Corners */}
          <div className="absolute top-4 left-4 w-16 h-16 border-t border-l border-terracotta/30" />
          <div className="absolute top-4 right-4 w-16 h-16 border-t border-r border-terracotta/30" />
          <div className="absolute bottom-4 left-4 w-16 h-16 border-b border-l border-terracotta/30" />
          <div className="absolute bottom-4 right-4 w-16 h-16 border-b border-r border-terracotta/30" />
